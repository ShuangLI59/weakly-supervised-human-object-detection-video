...
# ---------------------------------------------------------------------------- #
# Inference ('unseen') options
# ---------------------------------------------------------------------------- #
__C.UNSEEN = AttrDict()
__C.UNSEEN.DATASETS = ()
__C.UNSEEN.PROPOSAL_FILES = ()
...
__C.RESNETS.VHICO_PRETRAINED_WEIGHTS = ''
__C.RESNETS.VHICO_PRD_PRETRAINED_WEIGHTS = ''
...
__C.VGG16.VHICO_PRETRAINED_WEIGHTS = ''
__C.VGG16.VHICO_PRD_PRETRAINED_WEIGHTS = ''
